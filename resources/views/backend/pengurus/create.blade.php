                        ...
                        <div class="p-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text" name="nama_pengurus" id="nama_pengurus"
                                    ...
                                    placeholder="Masukkan nama pengurus" value="{{ old('nama_pengurus') }}" autofocus
                                    required>
                            </div>
                            <div class="row mb-3">
                                ...
                                <input type="text" name="latar_belakang" id="latar_belakang"
                                    ...
                                    placeholder="Masukkan latar belakang pengurus" value="{{ old('latar_belakang') }}"
                                    required>
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <select class="form-control @error('nama_jabatan') is-invalid @enderror"
                                    ...
                                    <option value="{{ $item->id }}" @if (old('jabatan_id')===$item->id)
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <select class="form-control @error('periode_id') is-invalid @enderror" name="periode_id"
                                    ...
                                    <option value="{{ $item->id }}" @if (old('periode_id')===$item->id)
                                        selected @endif>{{ $item->masa_periode }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="row mb-3 form-group d-flex flex-column">
