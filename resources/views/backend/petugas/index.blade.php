        ...
        <div class="modal-content">
            <form action="{{ route('petugas.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row mb-3">
                            <label for="name" class="col-sm-2 col-lg-12">Nama Petugas</label>
                            <input type="text" name="name" id="name"
                                class="form-control @error('name') is-invalid @enderror"
                                placeholder="Masukkan nama petugas" value="{{ old('name') }}" autofocus required>
                        </div>
                        <div class="row mb-3">
                            <label for="username" class="col-sm-2 col-lg-12">Username</label>
                            <input type="text" name="username" id="username"
                                class="form-control @error('username') is-invalid @enderror"
                                placeholder="Masukkan username petugas" value="{{ old('username') }}" required>
                        </div>
                        <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-lg-12">Email</label>
                            <input type="email" name="email" id="email"
                                class="form-control @error('email') is-invalid @enderror"
                                placeholder="Masukkan email petugas" value="{{ old('email') }}" required>
                        </div>
                        <div class="row mb-3">
                            <label for="password" class="col-sm-2 col-lg-12">Password</label>
                            <input type="password" name="password" id="password"
                                class="form-control @error('password') is-invalid @enderror"
                                placeholder="Masukkan password petugas" value="{{ old('password') }}" required>
                        </div>
                        <div class="row mb-3">
                            <label for="password_confirmation" class="col-sm-2 col-lg-12">Konfirmasi Password</label>
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                class="form-control @error('password_confirmation') is-invalid @enderror"
                                placeholder="Masukkan ulang password petugas" value="{{ old('password_confirmation') }}"
                                required>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modal-ubh-item{{ $id }}" role="dialog" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="{{ route('petugas.update', $id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row mb-3">
                            ...
                            <input type="text" name="name" id="name"
                                class="form-control @error('name') is-invalid @enderror"
                                placeholder="Masukkan nama petugas" value="{{ old('name', $item->name) }}" autofocus
                                required>
                        </div>
                        <div class="row mb-3">
                            <label for="username" class="col-sm-2 col-lg-12">Username</label>
                            <input type="text" name="username" id="username"
                                class="form-control @error('username') is-invalid @enderror"
                                placeholder="Masukkan username petugas" value="{{ old('username', $item->username) }}"
                                required>
                        </div>
                        <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-lg-12">Email</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <input type="password" name="new_password_confirmation" id="new_password_confirmation"
                                ...
                                placeholder="Masukkan password ulang baru petugas" required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
